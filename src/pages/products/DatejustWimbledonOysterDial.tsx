...
const DatejustWimbledonOysterDial: React.FC = () => {
  const [mainImage, setMainImage] = useState('https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-wimbledon-2tonesilvergold-oyster-fluted-41/datejust-wimbledon-2tonesilvergold-oyster-fluted-41.jpg');
  ...
  const images = [
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-wimbledon-2tonesilvergold-oyster-fluted-41/datejust-wimbledon-2tonesilvergold-oyster-fluted-41.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-wimbledon-2tonesilvergold-oyster-fluted-41/2.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-wimbledon-2tonesilvergold-oyster-fluted-41/3.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-wimbledon-2tonesilvergold-oyster-fluted-41/4.jpg',
  ];
  ...
  const handleAddToCart = () => {
    addItem({
      id: Date.now(),
      name: `Rolex Datejust Wimbledon Two-Tone Silver Gold Oyster Fluted 41 - ${selectedQuality.name}`,
        ...
        <div className="bg-gradient-to-b from-black to-zinc-900 py-12">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
              ...
              <ChevronRight className="h-4 w-4" />
              <span className="text-gold-500">Wimbledon Dial Two-Tone Oyster</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-4">
                <div className="max-w-lg mx-auto rounded-lg overflow-hidden bg-zinc-900">
                  <img
                    src={mainImage}
                    alt="Datejust 41mm Wimbledon Dial Two-Tone Oyster"
                ...
                <div className="grid grid-cols-4 gap-4 max-w-lg mx-auto">
                  {images.map((image, index) => (
                    ...
                    >
                      <img
                        src={image}
                        alt={`Datejust 41mm Wimbledon Dial Two-Tone Oyster view ${index + 1}`}
                        className="w-full h-full object-cover"
                      />
                    </button>
                  ))}
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-serif font-bold text-white mb-4">
                  Datejust 41mm Wimbledon Dial Two-Tone Oyster
                </h1>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between py-2 border-b border-zinc-800">
                      ...
                      <span className="text-white">Wimbledon</span>
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    The Rolex Datejust 41 Two-Tone with Wimbledon dial and Oyster bracelet combines sporty elegance with luxurious sophistication. This model features the iconic Wimbledon dial with its distinctive slate grey face and Roman numerals in 18 ct white gold with a green finish.
                  </p>
                  <p className="text-gray-400 leading-relaxed mt-4">
                    The two-tone case and bracelet combination of stainless steel and 18k gold creates a perfect balance of durability and luxury. The robust Oyster bracelet provides exceptional durability and comfort, while the fluted bezel adds a classic touch that has become synonymous with the Datejust collection. This timepiece is perfect for those who appreciate both luxury and practicality.
                  </p>
                </div>
              </div>
            </div>
...
export default DatejustWimbledonOysterDial;