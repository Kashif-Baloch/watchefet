...
const DatejustGreenOysterDial: React.FC = () => {
  const [mainImage, setMainImage] = useState('https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-greendial-champagne-silveroyster-domed-40/datejust-greendial-champagne-silveroyster-domed-40.jpg');
  ...
  const images = [
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-greendial-champagne-silveroyster-domed-40/datejust-greendial-champagne-silveroyster-domed-40.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-greendial-champagne-silveroyster-domed-40/2.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-greendial-champagne-silveroyster-domed-40/3.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-greendial-champagne-silveroyster-domed-40/4.jpg',
  ];
  ...
  const handleAddToCart = () => {
    addItem({
      id: Date.now(),
      name: `Rolex Datejust Green Dial Champagne Silver Oyster Domed - ${selectedQuality.name}`,
        ...
        <div className="bg-gradient-to-b from-black to-zinc-900 py-12">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
              ...
              <ChevronRight className="h-4 w-4" />
              <span className="text-gold-500">Green Dial Oyster</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-4">
                <div className="max-w-lg mx-auto rounded-lg overflow-hidden bg-zinc-900">
                  <img
                    src={mainImage}
                    alt="Datejust 41mm Green Dial Oyster"
                ...
                <div className="grid grid-cols-4 gap-4 max-w-lg mx-auto">
                  {images.map((image, index) => (
                    ...
                    >
                      <img
                        src={image}
                        alt={`Datejust 41mm Green Dial Oyster view ${index + 1}`}
                        className="w-full h-full object-cover"
                      />
                    </button>
                  ))}
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-serif font-bold text-white mb-4">
                  Datejust 41mm Green Dial Oyster
                </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between py-2 border-b border-zinc-800">
                      ...
                      <span className="text-white">Domed</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-zinc-800">
                ...
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    The Rolex Datejust 41 with Green Dial and Oyster bracelet offers a fresh and contemporary take on the classic Datejust design. This model features a stunning green dial that creates a vibrant, nature-inspired appearance, perfectly complemented by the clean lines of the domed bezel.
                  </p>
                  <p className="text-gray-400 leading-relaxed mt-4">
                    The 41mm case provides excellent presence on the wrist, while the sturdy Oyster bracelet offers exceptional comfort and a more sporty aesthetic compared to the Jubilee bracelet. The domed bezel gives this timepiece a more understated, versatile character compared to its fluted bezel counterparts, making it perfect for both casual and formal occasions. The combination of the green dial with the steel case and bracelet creates a distinctive and eye-catching timepiece.
                  </p>
                </div>
              </div>
            </div>
...
export default DatejustGreenOysterDial;