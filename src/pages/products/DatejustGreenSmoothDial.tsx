...
const DatejustGreenSmoothDial: React.FC = () => {
  const [mainImage, setMainImage] = useState('https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Smooth%20Bezel/datejust-greendial-champagne-smooth-silverjubilee/datejust-greendial-champagne-smooth-silverjubilee');
  ...
  const images = [
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Smooth%20Bezel/datejust-greendial-champagne-smooth-silverjubilee/datejust-greendial-champagne-smooth-silverjubilee',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Smooth%20Bezel/datejust-greendial-champagne-smooth-silverjubilee/2.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Smooth%20Bezel/datejust-greendial-champagne-smooth-silverjubilee/3.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Smooth%20Bezel/datejust-greendial-champagne-smooth-silverjubilee/4.jpg',
  ];
  ...
  const handleAddToCart = () => {
    addItem({
      id: Date.now(),
      name: `Rolex Datejust Greendial Champagne Smooth Silver Jubilee - ${selectedQuality.name}`,
        ...
        <div className="bg-gradient-to-b from-black to-zinc-900 py-12">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
              ...
              <ChevronRight className="h-4 w-4" />
              <span className="text-gold-500">Green Smooth Dial</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-4">
                <div className="max-w-lg mx-auto rounded-lg overflow-hidden bg-zinc-900">
                  <img
                    src={mainImage}
                    alt="Datejust 41mm Green Dial Smooth Bezel"
                ...
                <div className="grid grid-cols-4 gap-4 max-w-lg mx-auto">
                  {images.map((image, index) => (
                    ...
                    >
                      <img
                        src={image}
                        alt={`Datejust 41mm Green Dial Smooth Bezel view ${index + 1}`}
                        className="w-full h-full object-cover"
                      />
                    </button>
                  ))}
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-serif font-bold text-white mb-4">
                  Datejust 41mm Green Dial Smooth Bezel
                </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    The Rolex Datejust 41 with Green Dial and Smooth Bezel offers a fresh and modern 
                    interpretation of the classic Datejust design. This model features a stunning green 
                    dial that creates a vibrant, nature-inspired appearance, complemented by the clean 
                    lines of the smooth bezel. The 41mm case provides perfect proportions, while the 
                    signature Jubilee bracelet ensures exceptional comfort. The smooth bezel gives this 
                    timepiece a more contemporary, sporty character compared to its fluted bezel 
                    counterparts, making it a perfect choice for both casual and formal occasions.
                  </p>
                </div>
              </div>
            </div>
...
export default DatejustGreenSmoothDial;