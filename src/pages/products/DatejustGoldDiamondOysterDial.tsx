...
const DatejustGoldDiamondOysterDial: React.FC = () => {
  const [mainImage, setMainImage] = useState('https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-golddial-diamond-2tonesilvergoldoyster-fluted/datejust-golddial-diamond-2tonesilvergoldoyster-fluted');
  ...
  const images = [
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-golddial-diamond-2tonesilvergoldoyster-fluted/datejust-golddial-diamond-2tonesilvergoldoyster-fluted',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-golddial-diamond-2tonesilvergoldoyster-fluted/2.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-golddial-diamond-2tonesilvergoldoyster-fluted/3.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-golddial-diamond-2tonesilvergoldoyster-fluted/4.jpg',
  ];
  ...
  const handleAddToCart = () => {
    addItem({
      id: Date.now(),
      name: `Rolex Datejust Gold Dial Diamond Two-Tone Silver Gold Oyster Fluted - ${selectedQuality.name}`,
        ...
        <div className="bg-gradient-to-b from-black to-zinc-900 py-12">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
              ...
              <ChevronRight className="h-4 w-4" />
              <span className="text-gold-500">Gold Diamond Dial Oyster</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-4">
                <div className="max-w-lg mx-auto rounded-lg overflow-hidden bg-zinc-900">
                  <img
                    src={mainImage}
                    alt="Datejust 41mm Gold Diamond Dial Oyster"
                ...
                <div className="grid grid-cols-4 gap-4 max-w-lg mx-auto">
                  {images.map((image, index) => (
                    ...
                    >
                      <img
                        src={image}
                        alt={`Datejust 41mm Gold Diamond Dial Oyster view ${index + 1}`}
                        className="w-full h-full object-cover"
                      />
                    </button>
                  ))}
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-serif font-bold text-white mb-4">
                  Datejust 41mm Gold Diamond Dial Two-Tone Oyster
                </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    The Rolex Datejust 41 Two-Tone with Gold Diamond Dial and Oyster bracelet represents 
                    the perfect blend of luxury and durability. This model features a stunning gold dial 
                    adorned with diamond hour markers, creating an exquisite display of opulence. The 
                    two-tone case and bracelet combination of stainless steel and 18k gold adds a 
                    sophisticated touch, while the robust Oyster bracelet provides exceptional durability 
                    and comfort. The fluted bezel completes the classic Datejust aesthetic, making this 
                    timepiece a perfect choice for those who appreciate both luxury and practicality.
                  </p>
                </div>
              </div>
            </div>
...
export default DatejustGoldDiamondOysterDial;