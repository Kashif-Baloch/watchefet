...
const DatejustGoldChampagneOysterDial: React.FC = () => {
  const [mainImage, setMainImage] = useState('https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-golddial-champagne-2tonesilvergold-oyster-fluted-40/datejust-golddial-champagne-2tonesilvergold-oyster-fluted-40.jpg');
  ...
  const images = [
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-golddial-champagne-2tonesilvergold-oyster-fluted-40/datejust-golddial-champagne-2tonesilvergold-oyster-fluted-40.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-golddial-champagne-2tonesilvergold-oyster-fluted-40/2.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-golddial-champagne-2tonesilvergold-oyster-fluted-40/3.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-golddial-champagne-2tonesilvergold-oyster-fluted-40/4.jpg',
  ];
  ...
  const handleAddToCart = () => {
    addItem({
      id: Date.now(),
      name: `Rolex Datejust Gold Champagne Dial Two-Tone Silver Gold Oyster Fluted - ${selectedQuality.name}`,
        ...
        <div className="bg-gradient-to-b from-black to-zinc-900 py-12">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
              ...
              <ChevronRight className="h-4 w-4" />
              <span className="text-gold-500">Gold Champagne Dial Oyster</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-4">
                <div className="max-w-lg mx-auto rounded-lg overflow-hidden bg-zinc-900">
                  <img
                    src={mainImage}
                    alt="Datejust 41mm Gold Champagne Dial Two-Tone Oyster"
                ...
                <div className="grid grid-cols-4 gap-4 max-w-lg mx-auto">
                  {images.map((image, index) => (
                    ...
                    >
                      <img
                        src={image}
                        alt={`Datejust 41mm Gold Champagne Dial Two-Tone Oyster view ${index + 1}`}
                        className="w-full h-full object-cover"
                      />
                    </button>
                  ))}
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-serif font-bold text-white mb-4">
                  Datejust 41mm Gold Champagne Dial Two-Tone Oyster
                </h1>
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <span className="text-gray-400">(22 Reviews)</span>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between py-2 border-b border-zinc-800">
                      ...
                      <span className="text-white">904L Steel & 18k Gold</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-zinc-800">
                    ...
                    <div className="flex justify-between py-2 border-b border-zinc-800">
                      ...
                      <span className="text-white">Two-Tone Oyster</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-zinc-800">
                    ...
                    <div className="flex justify-between py-2 border-b border-zinc-800">
                      ...
                      <span className="text-white">Gold Champagne</span>
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    The Rolex Datejust 41 Two-Tone with Gold Champagne Dial and Oyster bracelet represents timeless elegance combined with robust durability. This model features a stunning champagne-colored dial that perfectly complements the two-tone case and bracelet combination of stainless steel and 18k gold.
                  </p>
                  <p className="text-gray-400 leading-relaxed mt-4">
                    The sturdy Oyster bracelet offers exceptional comfort and a more sporty aesthetic compared to the Jubilee bracelet. The fluted bezel adds a classic touch of luxury that has become synonymous with the Datejust collection. The warm tones of the dial create a sophisticated and versatile timepiece suitable for any occasion, while the robust construction ensures it's perfect for everyday wear.
                  </p>
                </div>
              </div>
            </div>
...
export default DatejustGoldChampagneOysterDial;