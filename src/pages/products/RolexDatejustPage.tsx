...
const RolexDatejustPage: React.FC = () => {
  const [mainImage, setMainImage] = useState('https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/datejust-blackchampagnedial-silverjubilee-fluted/datejust-blackchampagnedial-silverjubilee-fluted.png');
  ...
  const images = [
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/datejust-blackchampagnedial-silverjubilee-fluted/datejust-blackchampagnedial-silverjubilee-fluted.png',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/datejust-blackchampagnedial-silverjubilee-fluted/datejust-blackchampagnedial-silverjubilee-fluted.png',
    'https://gamzoandco.com/cdn/shop/products/IMG_4708_1600x.jpg?v=1681796977',
    'https://gamzoandco.com/cdn/shop/products/IMG_4709_1600x.jpg?v=1681796977',
  ];
  ...
  const handleAddToCart = () => {
    addItem({
      id: Date.now(),
      name: `Datejust 41mm Black Dial 2025 - ${selectedQuality.name}`,
        ...
        <div className="bg-gradient-to-b from-black to-zinc-900 py-12">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
              ...
              <ChevronRight className="h-4 w-4" />
              <span className="text-gold-500">Black Dial</span>
            </div>
                ...
                <div className="grid grid-cols-4 gap-4 max-w-lg mx-auto">
                  {images.map((image, index) => (
                    ...
                    >
                      <img
                        src={image}
                        alt={`Datejust 41mm Black Dial view ${index + 1}`}
                        className="w-full h-full object-cover"
                      />
                    </button>
                  ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    ...
                    features a stunning black dial housed in a 41mm case, perfectly balanced for both 
...
export default RolexDatejustPage;