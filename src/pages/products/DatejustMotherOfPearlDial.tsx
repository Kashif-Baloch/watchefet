...
const DatejustMotherOfPearlDial: React.FC = () => {
  const [mainImage, setMainImage] = useState('https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/datejust-mop-diamond-silverjubilee-fluted-41/datejust-mop-diamond-silverjubilee-fluted-41.jpg');
  ...
  const images = [
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/datejust-mop-diamond-silverjubilee-fluted-41/datejust-mop-diamond-silverjubilee-fluted-41.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/datejust-mop-diamond-silverjubilee-fluted-41/2.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/datejust-mop-diamond-silverjubilee-fluted-41/3.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/datejust-mop-diamond-silverjubilee-fluted-41/4.jpg',
  ];
  ...
  const handleAddToCart = () => {
    addItem({
      id: Date.now(),
      name: `Datejust 41mm Mother of Pearl Diamond Dial - ${selectedQuality.name}`,
        ...
        <div className="bg-gradient-to-b from-black to-zinc-900 py-12">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
              ...
              <ChevronRight className="h-4 w-4" />
              <span className="text-gold-500">Mother of Pearl Diamond Dial</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-4">
                <div className="max-w-lg mx-auto rounded-lg overflow-hidden bg-zinc-900">
                  <img
                    src={mainImage}
                    alt="Datejust 41mm Mother of Pearl Diamond Dial"
                ...
                <div className="grid grid-cols-4 gap-4 max-w-lg mx-auto">
                  {images.map((image, index) => (
                    ...
                    >
                      <img
                        src={image}
                        alt={`Datejust 41mm Mother of Pearl Diamond Dial view ${index + 1}`}
                        className="w-full h-full object-cover"
                      />
                    </button>
                  ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    The Rolex Datejust 41 with Mother of Pearl Diamond dial represents the epitome of 
                    luxury and sophistication. This exquisite timepiece features a stunning mother of 
                    pearl dial adorned with diamond hour markers, creating a mesmerizing play of light 
                    and iridescence. The 41mm case in 904L steel provides perfect proportions, while 
                    the signature Jubilee bracelet ensures exceptional comfort. The fluted bezel adds 
                    a classic touch of luxury that has become synonymous with the Datejust collection. 
                    The combination of the natural mother of pearl, diamonds, and steel creates a 
                    timepiece that is both elegant and distinctive.
                  </p>
                </div>
              </div>
            </div>
...
export default DatejustMotherOfPearlDial;