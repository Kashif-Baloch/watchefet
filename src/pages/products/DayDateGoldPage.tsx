...
const DayDateGoldPage: React.FC = () => {
  const [mainImage, setMainImage] = useState('https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Day-Date/daydate-whitedial-roman-gold-fluted-40/daydate-whitedial-roman-gold-fluted-40.png');
  ...
  const images = [
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Day-Date/daydate-whitedial-roman-gold-fluted-40/daydate-whitedial-roman-gold-fluted-40.png',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Day-Date/daydate-whitedial-roman-gold-fluted-40/2.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Day-Date/daydate-whitedial-roman-gold-fluted-40/3.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Day-Date/daydate-whitedial-roman-gold-fluted-40/4.jpg',
  ];
  ...
  const handleAddToCart = () => {
    // Add the watch with selected quality
    const productId = selectedQuality.name === 'Super Clone' 
      ? 'daydate-white-roman-gold-super-clone'
      : selectedQuality.name === 'AAAAA Grade'
        ? 'daydate-white-roman-gold-aaaaa'
        : 'daydate-white-roman-gold-aaa';
        
    addItem({
      id: Date.now(),
      name: `Rolex Day-Date White Roman Dial Gold Fluted - ${selectedQuality.name}`,
      price: selectedQuality.price,
      image: images[0],
      quality: selectedQuality.name,
    });

    // If premium box is selected, add it as a separate item
        ...
        <div className="bg-gradient-to-b from-black to-zinc-900 py-12">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
              ...
              <ChevronRight className="h-4 w-4" />
              <Link to="/rolex/day-date" className="hover:text-gold-500">Day-Date</Link>
              <ChevronRight className="h-4 w-4" />
              <span className="text-gold-500">White Roman Dial Gold</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-4">
                <div className="max-w-lg mx-auto rounded-lg overflow-hidden bg-zinc-900">
                  <img
                    src={mainImage}
                    alt="Day-Date 40 White Roman Dial Gold"
                ...
                <div className="grid grid-cols-4 gap-4 max-w-lg mx-auto">
                  {images.map((image, index) => (
                    ...
                    >
                      <img
                        src={image}
                        alt={`Day-Date 40 White Roman Dial Gold view ${index + 1}`}
                        className="w-full h-full object-cover"
                      />
                    </button>
                  ))}
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-serif font-bold text-white mb-4">
                  Day-Date 40 White Roman Dial Gold
                </h1>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between py-2 border-b border-zinc-800">
                      ...
                      <span className="text-white">18k Yellow Gold</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-zinc-800">
                    ...
                    <div className="flex justify-between py-2 border-b border-zinc-800">
                      ...
                      <span className="text-white">President</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-zinc-800">
                      <span className="text-gray-400">Bezel</span>
                      <span className="text-white">Fluted</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-zinc-800">
                      <span className="text-gray-400">Dial</span>
                      <span className="text-white">White with Roman Numerals</span>
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    The Rolex Day-Date 40 in 18k yellow gold with a white Roman numeral dial represents the pinnacle of prestige and elegance. This iconic timepiece features a fluted bezel that enhances its distinctive Rolex profile, while the President bracelet provides exceptional comfort and sophistication.
                  </p>
                  <p className="text-gray-400 leading-relaxed mt-4">
                    The Day-Date was the first wristwatch to display the date and day of the week spelled out in full in a window on the dial. With the President bracelet, originally created specifically for it, the Day-Date continues to be the watch par excellence of influential people, and remains the ultimate status watch.
                  </p>
                </div>
              </div>
            </div>
...
export default DayDateGoldPage;