...
const DayDateGoldDiamondPage: React.FC = () => {
  const [mainImage, setMainImage] = useState('https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Day-Date/daydate-golddial-champagne-goldpresident-diamondset-40/daydate-golddial-champagne-goldpresident-diamondset-40');
  ...
  const images = [
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Day-Date/daydate-golddial-champagne-goldpresident-diamondset-40/daydate-golddial-champagne-goldpresident-diamondset-40',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Day-Date/daydate-golddial-champagne-goldpresident-diamondset-40/2.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Day-Date/daydate-golddial-champagne-goldpresident-diamondset-40/3.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Day-Date/daydate-golddial-champagne-goldpresident-diamondset-40/4.jpg',
  ];
  ...
  const handleAddToCart = () => {
    ...
    addItem({
      id: Date.now(),
      name: `Rolex Day-Date Gold Diamond-Set President - ${selectedQuality.name}`,
        ...
        <div className="bg-gradient-to-b from-black to-zinc-900 py-12">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
              ...
              <ChevronRight className="h-4 w-4" />
              <span className="text-gold-500">Gold Diamond-Set President</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-4">
                <div className="max-w-lg mx-auto rounded-lg overflow-hidden bg-zinc-900">
                  <img
                    src={mainImage}
                    alt="Day-Date 40 Gold Diamond-Set President"
                ...
                <div className="grid grid-cols-4 gap-4 max-w-lg mx-auto">
                  {images.map((image, index) => (
                    ...
                    >
                      <img
                        src={image}
                        alt={`Day-Date 40 Gold Diamond-Set President view ${index + 1}`}
                        className="w-full h-full object-cover"
                      />
                    </button>
                  ))}
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-serif font-bold text-white mb-4">
                  Day-Date 40 Gold Diamond-Set President
                </h1>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between py-2 border-b border-zinc-800">
                      ...
                      <span className="text-white">President with Diamond Setting</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-zinc-800">
                      <span className="text-gray-400">Bezel</span>
                      <span className="text-white">Diamond-Set</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-zinc-800">
                      <span className="text-gray-400">Dial</span>
                      <span className="text-white">Gold Champagne with Diamond Hour Markers</span>
                    </div>
                  </div>
                </div>
                <div>
...
export default DayDateGoldDiamondPage;