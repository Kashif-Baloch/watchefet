...
const DatejustGreyDiamondOysterDial: React.FC = () => {
  const [mainImage, setMainImage] = useState('https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-greydial-diamond-silveroyster-fluted/datejust-greydial-diamond-silveroyster-fluted');
  ...
  const images = [
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-greydial-diamond-silveroyster-fluted/datejust-greydial-diamond-silveroyster-fluted',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-greydial-diamond-silveroyster-fluted/2.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-greydial-diamond-silveroyster-fluted/3.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-greydial-diamond-silveroyster-fluted/4.jpg',
  ];
  ...
  const handleAddToCart = () => {
    addItem({
      id: Date.now(),
      name: `Rolex Datejust Grey Dial Diamond Silver Oyster Fluted - ${selectedQuality.name}`,
        ...
        <div className="bg-gradient-to-b from-black to-zinc-900 py-12">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
              ...
              <ChevronRight className="h-4 w-4" />
              <span className="text-gold-500">Grey Diamond Dial Oyster</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-4">
                <div className="max-w-lg mx-auto rounded-lg overflow-hidden bg-zinc-900">
                  <img
                    src={mainImage}
                    alt="Datejust 41mm Grey Diamond Dial Oyster"
                ...
                <div className="grid grid-cols-4 gap-4 max-w-lg mx-auto">
                  {images.map((image, index) => (
                    ...
                    >
                      <img
                        src={image}
                        alt={`Datejust 41mm Grey Diamond Dial Oyster view ${index + 1}`}
                        className="w-full h-full object-cover"
                      />
                    </button>
                  ))}
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-serif font-bold text-white mb-4">
                  Datejust 41mm Grey Diamond Dial Oyster
                </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    The Rolex Datejust 41 with Grey Diamond Dial and Oyster bracelet combines elegance with 
                    robustness. This model features a sophisticated grey dial adorned with diamond hour 
                    markers, creating a perfect balance of luxury and understatement. The 41mm case in 
                    904L steel provides excellent durability, while the sturdy Oyster bracelet offers 
                    exceptional comfort and a more sporty aesthetic compared to the Jubilee bracelet. 
                    The fluted bezel adds a classic touch of luxury that has become synonymous with the 
                    Datejust collection. This timepiece is perfect for those who appreciate refined luxury 
                    with a more robust, everyday wearable design.
                  </p>
                </div>
              </div>
            </div>
...
export default DatejustGreyDiamondOysterDial;