...
const DatejustMotherOfPearlOysterDial: React.FC = () => {
  const [mainImage, setMainImage] = useState('https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-mop-diamond-silveroyster-fluted/datejust-mop-diamond-silveroyster-fluted');
  ...
  const images = [
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-mop-diamond-silveroyster-fluted/datejust-mop-diamond-silveroyster-fluted',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-mop-diamond-silveroyster-fluted/2.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-mop-diamond-silveroyster-fluted/3.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/Oyster/datejust-mop-diamond-silveroyster-fluted/4.jpg',
  ];
  ...
  const handleAddToCart = () => {
    addItem({
      id: Date.now(),
      name: `Datejust 41mm Mother of Pearl Diamond Dial Oyster - ${selectedQuality.name}`,
        ...
        <div className="bg-gradient-to-b from-black to-zinc-900 py-12">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
              ...
              <ChevronRight className="h-4 w-4" />
              <span className="text-gold-500">Mother of Pearl Diamond Dial Oyster</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-4">
                <div className="max-w-lg mx-auto rounded-lg overflow-hidden bg-zinc-900">
                  <img
                    src={mainImage}
                    alt="Datejust 41mm Mother of Pearl Diamond Dial Oyster"
                ...
                <div className="grid grid-cols-4 gap-4 max-w-lg mx-auto">
                  {images.map((image, index) => (
                    ...
                    >
                      <img
                        src={image}
                        alt={`Datejust 41mm Mother of Pearl Diamond Dial Oyster view ${index + 1}`}
                        className="w-full h-full object-cover"
                      />
                    </button>
                  ))}
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between py-2 border-b border-zinc-800">
                      ...
                      <span className="text-white">Oyster</span>
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    The Rolex Datejust 41 with Mother of Pearl Diamond Dial and Oyster bracelet combines 
                    exquisite luxury with robust sportiness. This exceptional timepiece features a stunning 
                    mother of pearl dial adorned with diamond hour markers, creating a mesmerizing play of 
                    light and iridescence. The 41mm case in 904L steel provides perfect proportions, while 
                    the sturdy Oyster bracelet offers a more sporty and versatile aesthetic compared to the 
                    Jubilee bracelet. The fluted bezel adds a classic touch of luxury that has become 
                    synonymous with the Datejust collection. The combination of the natural mother of pearl, 
                    diamonds, and the robust Oyster bracelet creates a timepiece that is both elegant and 
...
export default DatejustMotherOfPearlOysterDial;