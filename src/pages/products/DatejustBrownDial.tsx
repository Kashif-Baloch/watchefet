...
const DatejustBrownDial: React.FC = () => {
  const [mainImage, setMainImage] = useState('https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/datejust-browndial-champagne-2tonesilverrose-jubilee-fluted/datejust-browndial-champagne-2tonesilverrose-jubilee-fluted');
  ...
  const images = [
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/datejust-browndial-champagne-2tonesilverrose-jubilee-fluted/datejust-browndial-champagne-2tonesilverrose-jubilee-fluted',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/datejust-browndial-champagne-2tonesilverrose-jubilee-fluted/2.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/datejust-browndial-champagne-2tonesilverrose-jubilee-fluted/3.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/datejust-browndial-champagne-2tonesilverrose-jubilee-fluted/4.jpg',
  ];
  ...
  const handleAddToCart = () => {
    addItem({
      id: Date.now(),
      name: `Rolex Datejust Brown Champagne Dial Two-Tone Silver Rose Jubilee Fluted - ${selectedQuality.name}`,
        ...
        <div className="bg-gradient-to-b from-black to-zinc-900 py-12">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
              ...
              <ChevronRight className="h-4 w-4" />
              <span className="text-gold-500">Brown Dial</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="grid grid-cols-4 gap-4 max-w-lg mx-auto">
                  {images.map((image, index) => (
                    ...
                    >
                      <img
                        src={image}
                        alt={`Datejust 41mm Brown Dial view ${index + 1}`}
                        className="w-full h-full object-cover"
                      />
                    </button>
                  ))}
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-serif font-bold text-white mb-4">
                  Datejust 41mm Brown Dial Two-Tone
                </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    The Rolex Datejust 41 Two-Tone with Brown Champagne dial exemplifies refined elegance. 
                    This model features a stunning brown champagne dial that creates a warm, sophisticated 
                    appearance, perfectly complemented by the two-tone combination of stainless steel and 
                    18k rose gold. The signature Jubilee bracelet provides exceptional comfort, while the 
                    fluted bezel adds a classic touch of luxury. The harmonious blend of colors and 
                    materials makes this timepiece a versatile choice for both formal and casual occasions.
                  </p>
                </div>
              </div>
            </div>
...
export default DatejustBrownDial;