...
const DatejustWhiteChampagneDial: React.FC = () => {
  const [mainImage, setMainImage] = useState('https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/datejust-whitedial-champagne-silverjubilee-fluted/datejust-whitedial-champagne-silverjubilee-fluted-41');
  ...
  const images = [
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/datejust-whitedial-champagne-silverjubilee-fluted/datejust-whitedial-champagne-silverjubilee-fluted-41',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/datejust-whitedial-champagne-silverjubilee-fluted/2.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/datejust-whitedial-champagne-silverjubilee-fluted/3.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Datejust/datejust-whitedial-champagne-silverjubilee-fluted/4.jpg',
  ];
  ...
  const handleAddToCart = () => {
    addItem({
      id: Date.now(),
      name: `Rolex Datejust White Dial Champagne Silver Jubilee Fluted - ${selectedQuality.name}`,
        ...
        <div className="bg-gradient-to-b from-black to-zinc-900 py-12">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
              ...
              <ChevronRight className="h-4 w-4" />
              <span className="text-gold-500">White Champagne Dial</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-4">
                <div className="max-w-lg mx-auto rounded-lg overflow-hidden bg-zinc-900">
                  <img
                    src={mainImage}
                    alt="Datejust 41mm White Champagne Dial"
                ...
                <div className="grid grid-cols-4 gap-4 max-w-lg mx-auto">
                  {images.map((image, index) => (
                    ...
                    >
                      <img
                        src={image}
                        alt={`Datejust 41mm White Champagne Dial view ${index + 1}`}
                        className="w-full h-full object-cover"
                      />
                    </button>
                  ))}
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-serif font-bold text-white mb-4">
                  Datejust 41mm White Champagne Dial
                </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    The Rolex Datejust 41 with White Champagne dial embodies timeless elegance. 
                    This model features a stunning white champagne dial that creates a subtle, 
                    sophisticated appearance. The 41mm case in 904L steel provides perfect proportions, 
                    while the signature Jubilee bracelet ensures exceptional comfort. The fluted bezel 
                    adds a classic touch of luxury that has become synonymous with the Datejust collection. 
                    The combination of the champagne dial with the steel case and bracelet creates a 
                    versatile timepiece suitable for any occasion.
                  </p>
                </div>
              </div>
            </div>
...
export default DatejustWhiteChampagneDial;