...
const DayDateIceBluePage: React.FC = () => {
  const [mainImage, setMainImage] = useState('https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Day-Date/daydate-icebluedial-champagne-silver-smooth/daydate-icebluedial-champagne-silver-smooth');
  ...
  const images = [
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Day-Date/daydate-icebluedial-champagne-silver-smooth/daydate-icebluedial-champagne-silver-smooth',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Day-Date/daydate-icebluedial-champagne-silver-smooth/2.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Day-Date/daydate-icebluedial-champagne-silver-smooth/3.jpg',
    'https://pgkfybgojqakmfwyneqb.supabase.co/storage/v1/object/public/product-images/Rolex/Day-Date/daydate-icebluedial-champagne-silver-smooth/4.jpg',
  ];
  ...
  const handleAddToCart = () => {
    ...
    addItem({
      id: Date.now(),
      name: `Rolex Day-Date Ice Blue Champagne Dial Silver Smooth Bezel - ${selectedQuality.name}`,
        ...
        <div className="bg-gradient-to-b from-black to-zinc-900 py-12">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
              ...
              <ChevronRight className="h-4 w-4" />
              <span className="text-gold-500">Ice Blue Dial</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="grid grid-cols-4 gap-4 max-w-lg mx-auto">
                  {images.map((image, index) => (
                    ...
                    >
                      <img
                        src={image}
                        alt={`Day-Date 40 Ice Blue Dial view ${index + 1}`}
                        className="w-full h-full object-cover"
                      />
                    </button>
                  ))}
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-serif font-bold text-white mb-4">
                  Day-Date 40 Ice Blue Dial Silver
                </h1>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between py-2 border-b border-zinc-800">
                      ...
                      <span className="text-white">Ice Blue</span>
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    The Rolex Day-Date 40 with Ice Blue dial is a stunning timepiece that exudes elegance and sophistication. The distinctive ice blue dial is a signature color reserved exclusively for Rolex's platinum models, making this watch truly special.
                  </p>
                  <p className="text-gray-400 leading-relaxed mt-4">
                    This model features a smooth bezel and the iconic President bracelet, which was created specifically for the Day-Date when it was launched in 1956. The Day-Date was the first wristwatch to display the date and day of the week spelled out in full in a window on the dial, and continues to be the watch of choice for influential people worldwide.
                  </p>
                </div>
              </div>
            </div>
...
export default DayDateIceBluePage;