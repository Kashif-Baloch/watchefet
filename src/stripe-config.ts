export const products = {
  ...
  'datejust-gold-oyster-super-clone': {
    ...
    name: 'Rolex Datejust Gold Champagne Dial Two-Tone Silver Gold Oyster Fluted - Super Clone',
    description: 'Highest quality replica with Swiss clone movement',
    mode: 'payment'
  },
  'datejust-gold-oyster-aaaaa': {
    ...
    name: 'Rolex Datejust Gold Champagne Dial Two-Tone Silver Gold Oyster Fluted - AAAAA Grade',
    description: 'Premium replica with enhanced movement and finishing',
    mode: 'payment'
  },
  'datejust-gold-oyster-aaa': {
    ...
    name: 'Rolex Datejust Gold Champagne Dial Two-Tone Silver Gold Oyster Fluted - AAA Grade',
    description: 'High-quality replica with standard movement',
    mode: 'payment'
  },
