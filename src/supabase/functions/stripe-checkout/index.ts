...
const products: Record<string, Product> = {
  'daydate-black-gold-super-clone': {
    priceId: 'price_1RRvTHL7hSvB5SHWXYZnPqLm',
  ...
  'datejust-green-oyster-super-clone': {
    ...
    name: 'Rolex Datejust Green Dial Champagne Silver Oyster Smooth Bezel - Super Clone',
    description: 'Highest quality replica with Swiss clone movement',
    mode: 'payment'
  },
  'datejust-green-oyster-aaaaa': {
    ...
    name: 'Rolex Datejust Green Dial Champagne Silver Oyster Smooth Bezel - AAAAA Grade',
    description: 'Premium replica with enhanced movement and finishing',
    mode: 'payment'
  },
  'datejust-green-oyster-aaa': {
    ...
    name: 'Rolex Datejust Green Dial Champagne Silver Oyster Smooth Bezel - AAA Grade',
    description: 'High-quality replica with standard movement',
    mode: 'payment'
  },
...
serve(async (req) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      metadata: {
        productIds: items.map((item: CartItem) => item.productId).join(',')
      }
    });
