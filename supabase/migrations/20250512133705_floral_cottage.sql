/*
  ...
  1. New Tables
    ...
    - `model_requests`: Stores watch model requests
      - Includes customer details and watch specifications
      - Tracks request status and timestamps

  2. Security
    - Enables Row Level Security (RLS)
    - Implements policies for data access
*/
